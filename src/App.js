        ...
        <div className="container-fluid">
          ...
          <div className="d-none d-lg-flex justify-content-between w-100 align-items-center">
            <ul className="navbar-nav d-flex align-items-center">
              ...
              {isLoggedIn && <li className="nav-item ms-3"><Link to="/admin" className="nav-link">Admin Panel</Link></li>}
            </ul>
            <div className="d-flex align-items-center">
              <a href="mailto:userr776@proton.me" className="nav-link me-4">Contact Us</a>
              <a href="https://github.com/RaulAbakarov" target="_blank" rel="noopener noreferrer" className="nav-link me-3"><i className="bi bi-github"></i></a>
              <a href="https://instagram.com/_wfwycl" target="_blank" rel="noopener noreferrer" className="nav-link me-3"><i className="bi bi-instagram"></i></a>
              <a href="https://www.linkedin.com/in/raulabakarov/" target="_blank" rel="noopener noreferrer" className="nav-link"><i className="bi bi-linkedin"></i></a>
            </div>
          </div>
          {!isMobile && showCenterBrand && (
            <Link to="/" className="position-absolute top-50 start-50 translate-middle fw-bold fs-4 text-dark text-decoration-none d-none d-lg-block">
              TecHoneStory
            </Link>
          )}
        </div>
